...
clear&&clear
echo -e "\033[1;31m———————————————————————————————————————————————————\033[1;37m"
echo -e "\033[1;32m            PAYLOAD + SSL ✔️by: LAG13 "
echo -e "\033[1;31m———————————————————————————————————————————————————\033[1;37m"
...
RESPONSE = 'HTTP/1.1 101 Switching Protocols <strong><h1><div><font color="#00ffff">V</font><font color="#ffffff">p</font><font color="#00ffff">s </font><font color="#ffffff"> |</font><font color="#00ffff">b</font><font color="#ffffff">y</font><font color="#00ffff">:</font><font color="#ff0000">~</font><font color="#00ffff">L</font><font color="#ffffff">A</font><font color="#00ffff">G</font><font color="#ffffff">1</font><font color="#00ffff">3</font><font color="#ff0000">~</font></div></h1></strong>\r\nContent-length: 0\r\n\r\n'
...
fun_bar 'inst_py'
rm -rf proxy.py
echo -e "INSTALACIÓN TERMINADA \e[0;31mby: LAG13\e[0m"
